...
abstract class MyElefantConfig
{
    ...
    const CRITICAL_MESSAGE_CONTACT_FORMAT = 'Contact must be a multidimensional array. Example [[\'33601020304\', \'John\',\'Doe\']]';
    const CRITICAL_MESSAGE_CONTENT_FORMAT = 'Content must be an array and first parameter must be a mobile phone number. Example [\'33601020304\',\'First content\',\'...\']';
    ...
    const CRITICAL_MESSAGE_PHONE_NUMBER_FORMAT = 'Format invalid, expected MOBILE phone number. Example \'33612232305\'';
